...
type Response = Either<string, null>;

export class SignupValidation implements Validation<SignupController.Request, string> {
  validate(input: Request): Response {
    const schema = yup.object({
      ...
      passwordConfirmation: yup
        ...
        .oneOf([yup.ref('password')], 'A confirmação de senha é inválida'),
    });
